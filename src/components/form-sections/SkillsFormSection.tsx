...
const SkillsFormSectionComponent = ({
  ...
  const handleTriggerSkillInfoDialog = React.useCallback((skillId: string) => {
    onOpenSkillInfoDialog(skillId);
  }, [onOpenSkillInfoDialog]);

  const handleTriggerSkillRollDialog = React.useCallback((skillId: string) => {
  ...
  }, [translations, actualAbilityScores, aggregatedFeatEffects, allCombinedSkillDefinitions, characterSkillInstances, allCustomSkillDefinitions, characterRace, characterSize, onOpenRollDialog, rerollTwentiesForChecks]);
