                    ...
                    >
                      ...
                      {prereqMessages.length > 0 ? (
                        <p className="text-xs mt-0.5 whitespace-normal">
                         ...
                         <p className="text-xs mt-0.5 whitespace-normal text-muted-foreground/80"><strong className="font-semibold text-muted-foreground">Prerequisites:</strong> None</p>
                      )}
                    </CommandItem>
                  );
                })}
