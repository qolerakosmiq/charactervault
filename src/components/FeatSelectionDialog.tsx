                    ...
                    >
                      ...
                      {prereqMessages.length > 0 ? (
                        <p className="text-xs mt-0.5 whitespace-normal">
                          <b className="text-muted-foreground">Prerequisites:</b>{' '}
                         ...
                         <p className="text-xs mt-0.5 whitespace-normal text-muted-foreground/80"><b className="text-muted-foreground">Prerequisites:</b> None</p>
                      )}
                    </CommandItem>
                  );
                })}
