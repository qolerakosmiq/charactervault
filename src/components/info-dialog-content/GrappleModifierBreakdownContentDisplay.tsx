  ...
  return (
    <div>
      ...
      <div className="space-y-1 text-sm">
        ...
        <div className="flex justify-between">
          <span>
             {(uiStrings.infoDialogGrappleModAbilityLabel || "{abilityAbbr} ({abilityFull}) Modifier:").replace("{abilityAbbr}", abilityLabels.find(al => al.value === 'strength')?.abbr || 'STR').replace("{abilityFull}", abilityLabels.find(al => al.value === 'strength')?.label || 'Strength')}
          </span>
