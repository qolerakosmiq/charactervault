...
export const GrappleDamageBreakdownContentDisplay: React.FC<GrappleDamageBreakdownContentDisplayProps> = ({
  ...
  return (
    <div>
      ...
      <div className="space-y-1 text-sm">
        ...
        <div className="flex justify-between">
          <span>
            {(uiStrings.infoDialogGrappleDmgAbilityLabel || "{abilityAbbr} ({abilityFull}) Modifier:").replace("{abilityAbbr}", abilityLabels.find(al => al.value === 'strength')?.abbr || 'STR').replace("{abilityFull}", abilityLabels.find(al => al.value === 'strength')?.label || 'Strength')}
          </span>
