...
interface MeleeDamageBreakdownContentDisplayProps {
  components?: GenericBreakdownItem[];
  uiStrings: Record<string, string>;
}

export const MeleeDamageBreakdownContentDisplay = ({
  components,
  uiStrings,
}: MeleeDamageBreakdownContentDisplayProps) => {
    ...
    <div>
      ...
      <div className="space-y-0.5">
        ...
        {otherNumericComponents.map((item, index) => {
          ...
          return (
            <div key={`melee-dmg-comp-${index}`} className="flex justify-between text-sm items-baseline">
