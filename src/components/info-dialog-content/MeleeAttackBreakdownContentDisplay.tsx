...
interface MeleeAttackBreakdownContentDisplayProps {
  components?: GenericBreakdownItem[];
  uiStrings: Record<string, string>;
}

export const MeleeAttackBreakdownContentDisplay = ({
  components,
  uiStrings,
}: MeleeAttackBreakdownContentDisplayProps) => {
  ...
  return (
    <div>
      {/* The main dialog title is handled by InfoDisplayDialog */}
      ...
      <div className="space-y-0.5">
        {regularComponents.map((item, index) => {
          ...
          if (labelMatch) {
              ...
              // This is a simplified check for an ability abbreviation.
              // A more robust check might involve comparing against a list of known ABILITY_LABELS.abbr if available.
          ...
          return (
            <div key={`melee-atk-comp-${index}`} className="flex justify-between text-sm items-baseline">
