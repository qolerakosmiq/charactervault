...
export interface GrantedWeapon {
  slot: GearSlotId;
...
export type InfoDialogContentType =
  ...
  | { type: 'meleeAttackBreakdown'; components: GenericBreakdownItem[]; subtitle?: string; }
  | { type: 'meleeDamageBreakdown'; components: GenericBreakdownItem[]; subtitle?: string; }
  | { type: 'rangedAttackBreakdown'; components: GenericBreakdownItem[]; subtitle?: string; }
  | { type: 'rangedDamageBreakdown'; components: GenericBreakdownItem[]; subtitle?: string; }
  | { type: 'genericNumericalBreakdown'; titleKey: keyof ProcessedSiteData['UI_STRINGS']; components: GenericBreakdownItem[]; subtitle?: string; }
